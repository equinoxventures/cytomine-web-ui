...
import { GEOMETRY_TYPE } from 'vuelayers/lib/ol-ext/consts';
import { initFeature } from 'vuelayers/lib/ol-ext/feature';
...
import { camelCase, isFunction, mapValues, upperFirst } from 'vuelayers/lib/util/minilo';

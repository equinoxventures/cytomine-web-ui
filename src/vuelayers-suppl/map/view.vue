...
import Vue from 'vue';
import { olCmp, projTransforms } from 'vuelayers/lib/mixin';
import { EPSG_3857, MAX_ZOOM, MIN_ZOOM, ZOOM_FACTOR } from 'vuelayers/lib/ol-ext';
import { observableFromOlChangeEvent } from 'vuelayers/lib/rx-ext';
import { hasView } from 'vuelayers/lib/util/assert';
import { coalesce, isEqual, isFunction, isPlainObject, noop } from 'vuelayers/lib/util/minilo';
